          ...
          <div className="hidden lg:block">
            <div className="space-y-8 text-center lg:text-left">
              <div className="inline-flex items-center gap-3 bg-white/20 dark:bg-gray-800/40 backdrop-blur-sm px-6 py-3 rounded-full border border-white/30 dark:border-gray-700/30">
                ...
                <span className="text-purple-700 dark:text-purple-300 font-medium">Join Kommercio Today</span>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-white/30 dark:border-gray-700/30">
                  <div className="p-2 bg-green-500 rounded-full">
                    <ShoppingBag className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-200 font-medium">Free shipping on first order</span>
                </div>
                <div className="flex items-center gap-3 p-4 bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-white/30 dark:border-gray-700/30">
                  <div className="p-2 bg-blue-500 rounded-full">
                    <Star className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-200 font-medium">Exclusive member discounts</span>
                </div>
                <div className="flex items-center gap-3 p-4 bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-white/30 dark:border-gray-700/30">
                  <div className="p-2 bg-purple-500 rounded-full">
                    <UserCheck className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-200 font-medium">24/7 premium support</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <Card className="w-full max-w-md relative overflow-hidden border-0 shadow-2xl shadow-purple-500/20 dark:shadow-purple-500/40 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl">
              ...
              <CardContent className="relative z-10 space-y-5">
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input 
                        ...
                        className="pl-14 h-12 border-2 border-gray-200 dark:border-gray-700 focus:border-purple-500 dark:focus:border-purple-400 rounded-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm transition-all duration-300 hover:bg-white/90 dark:hover:bg-gray-800/90 focus:bg-white dark:focus:bg-gray-800 text-gray-700 dark:text-gray-200 placeholder:text-gray-400 dark:placeholder:text-gray-500 shadow-sm"
                      />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="username" className="text-gray-700 dark:text-gray-200 font-medium">Username</Label>
                    <div className="relative group">
                      <User className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-purple-500 dark:group-hover:text-purple-400 transition-colors z-10" />
                      <Input
                        id="username"
                        type="text"
                        value={username}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="role" className="text-gray-700 dark:text-gray-200 font-medium">Account Type</Label>
                    <Select value={role} onValueChange={setRole}>
                      <SelectTrigger className="h-12 border-2 border-gray-200 dark:border-gray-700 focus:border-purple-500 dark:focus:border-purple-400 rounded-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm transition-all duration-300 hover:bg-white/90 text-gray-700">
                        <SelectValue />
                      </SelectTrigger>
